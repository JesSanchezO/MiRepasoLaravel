...
<table>
        <tr>
            <td width="35%">
    <p>
        Artista mexicana <br>(1907/07/06 - 1954/07/13)
        <br> 
        <img float="left" src="https://www.alejandradeargos.com/images/articulos/Marina/Frida_Kalho.JPG" alt="dorama.jpg" width="300" height="350">
        <img float="left" src="https://i1.wp.com/www.culturavia.com/wp-content/uploads/2015/12/autorretrato-con-collas-espinas-colibri-frida-kahlo.jpg?fit=590%2C769" alt="dorama.jpg" width="300" height="350">
        <img float="left" src="https://i0.wp.com/artefeed.com/wp-content/uploads/2015/04/Las-dos-fridas-autorretrato.jpg?resize=830%2C834&ssl=1" alt="dorama.jpg" width="300" height="350">
        <img float="left" src="https://a.wattpad.com/cover/127062681-352-k10687.jpg" alt="dorama.jpg" width="300" height="350">
...
<td>
<p>
    Una de las artistas más icónicas de México. <br>
        Obras: Las dos Fridas, La columna rota... <br>
        Género: Surrealismo, realismo mágico <br>
        Padres: Guillermo Kahlo y Matilde Calderón <br>
        Cónyuge: Diego Rivera <br>
        Nombre: Magdalena Carmen Frida Kahlo Calderón <br>
        Altura: 1,6 m <br> <br>
...
El matrimonio Kahlo-Rivera fue miembro del Partido Comunista Mexicano. La casa que la pintora habitó durante su vida conyugal con el célebre pintor, fue donada por este a la nación y transformada en el Museo que lleva el nombre de Frida Kahlo.
     <br> <br>
     <img float="center" src="https://museosdelmundo.com/wp-content/uploads/2019/05/Frida-Kahlo-5-1-785x1024.jpg" alt="dorama.jpg" width="300" height="350"> 
     <img float="center" src="https://http2.mlstatic.com/frida-kahlo-pinturas-en-lienzo-canvas-bastidor-calidad-museo-D_NQ_NP_825880-MLM32518536975_102019-F.jpg" alt="dorama.jpg" width="300" height="350">
